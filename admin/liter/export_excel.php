...
if ($search != NULL and $start_year != NULL and $end_year != NULL) {
    ...
    WHERE (`year_of_pub` >= '$start_year' AND `year_of_pub` <='$end_year')  AND (`title` LIKE '%$search%'  OR `year_of_pub` LIKE '%$search%')") or die(mysqli_error($connect));
  } elseif ($search != NULL and $start_year != NULL) {
    $literatures = mysqli_query($connect, "SELECT * FROM `literature`  
    WHERE `year_of_pub` >= '$start_year' AND (`title` LIKE '%$search%' OR `author` LIKE '%$search%' OR `year_of_pub` LIKE '%$search%')") or die(mysqli_error($connect));
  } elseif ($search != NULL and $end_year != NULL) {
    $literatures = mysqli_query($connect, "SELECT * FROM `literature`  
    WHERE `year_of_pub` <= '$end_year' AND `title` LIKE '%$search%' OR `author` LIKE '%$search%' OR `year_of_pub` LIKE '%$search%' ") or die(mysqli_error($connect));
  } elseif ($end_year != NULL) {
    $literatures = mysqli_query($connect, "SELECT * FROM `literature`  
    WHERE `year_of_pub` <= '$end_year' ") or die(mysqli_error($connect));
  } elseif ($start_year != NULL) {
    $literatures = mysqli_query($connect, "SELECT * FROM `literature`  
    WHERE `year_of_pub` >= '$start_year' ") or die(mysqli_error($connect));
  } elseif ($search != NULL) {
    $literatures = mysqli_query($connect, "SELECT * FROM `literature`  
    WHERE  `title` LIKE '%$search%' OR `author` LIKE '%$search%' OR `year_of_pub` LIKE '%$search%'") or die(mysqli_error($connect));
  } else {
